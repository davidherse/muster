...
class EstimateTest < ActiveSupport::TestCase
  ...
  test "recalculate_totals! sums line items into total and range" do
    ...
    assert_equal (900 + 455).to_d, @estimate.total_low
    assert_equal (1100 + 945).to_d, @estimate.total_high
  end
